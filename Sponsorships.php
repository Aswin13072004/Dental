...
<section class="breadcrumb-area" style="background-image: url(./images/sponsership/SponsorshipCropped.png);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="left pull-left">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box">
                        <p><b>Partner with Soft Smile Dental Centre: Sponsorship Opportunities</b>
                            <br>At Soft Smile Dental Centre, we believe in giving back to the community and supporting initiatives that promote oral health and well-being. We offer sponsorship opportunities for organizations, events, and individuals who share our commitment to making a positive impact in the dental community and beyond.
                            <br>
                            <br><b>Why Partner with Soft Smile Dental Centre?</b>
                            <br>
                            <br><b>Community Engagement:</b> Partnering with Soft Smile Dental Centre allows you to engage with our community of patients, dental professionals, and stakeholders, demonstrating your commitment to supporting local initiatives and promoting oral health awareness.
                            <br><b>Brand Visibility:</b> Gain exposure and visibility for your brand through our marketing channels, including our website, social media platforms, and promotional materials. Reach a targeted audience of dental professionals, patients, and community members who value quality dental care and wellness.
                            <br><b>Networking Opportunities:</b> Connect with like-minded individuals and organizations in the dental industry through our sponsorship events and initiatives. Build meaningful relationships and collaborations that can lead to future opportunities for growth and partnership.
                            <br>
                            <br><b>Sponsorship Opportunities:</b>
                            <br><b>Community Events:</b> Sponsor our community events, such as dental health fairs, oral hygiene workshops, and charity fundraisers, to support important causes and promote oral health education in the community.
                            <br><b>Educational Programs:</b> Sponsor our educational programs and initiatives aimed at advancing dental education and professional development. Support the next generation of dental professionals by investing in scholarships, training programs, and mentorship opportunities.
                            <br><b>Research and Innovation:</b> Partner with us to support dental research projects and innovative initiatives that contribute to advancements in dental science and technology. Help us drive innovation and excellence in dental care through your sponsorship.
                            <br>
                            <br><b>Customized Sponsorship Packages:</b>
                            
                            <br>We offer customized sponsorship packages tailored to meet your specific goals, objectives, and budget. Whether you're looking to increase brand visibility, support a particular cause, or engage with our community in a meaningful way, we'll work with you to create a sponsorship package that aligns with your values and priorities.
                            <br>
                            <br><b>Get Involved:</b>
                            
                            <br>Ready to make a difference in the dental community? Contact Soft Smile Dental Centre to learn more about our sponsorship opportunities and how you can partner with us to support our mission of promoting oral health and wellness. Together, we can make a positive impact and create brighter smiles for our community.</p>
                    </div>
                    <div class="img-box">
                        <div class="row">
                            <!--Start single item-->
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/sponsership/1.png" alt="Awesome Image">
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/sponsership/2.png" alt="Awesome Image">
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
