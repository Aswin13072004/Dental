...
<section class="breadcrumb-area" style="background-image: url(./images/CommonLaboratory/CommonLabCropped.png);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="left pull-left">
                    <div class="title">
                        <h1>Common Laboratory</h1>
                    </div>
                </div>
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Common Laboratory</li>
                    </ul> 
                </div>    
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box">
                        <p><h1>Trusted Dental Laboratory Services</h1>
                            <br>
                            At Soft Smile Dental Centre, we collaborate with reputable dental laboratories to ensure the highest quality of care for our patients. Our affiliated dental laboratory provides a range of services to support your dental needs, including:
                            <br>
                            <br><b>Custom Dental Restorations:</b> From crowns and bridges to veneers and implants, our dental laboratory specializes in crafting custom-made restorations that blend seamlessly with your natural smile.
                            <br 
                            <br><b>Prosthetic Fabrication:</b> Whether you require partial or complete dentures, our skilled technicians use advanced techniques and materials to create comfortable and lifelike prosthetics tailored to your unique specifications.
                            <br
                            <br><b>Orthodontic Appliances:</b> Our laboratory offers a variety of orthodontic appliances, such as retainers and aligners, to help you achieve a straighter and healthier smile.
                            <br
                            <br><b>Digital Dentistry Solutions:</b>Utilizing state-of-the-art technology, our dental laboratory employs digital dentistry solutions for precise and efficient fabrication of dental prosthetics, ensuring optimal fit and function.
                            <br>
                            <br>For inquiries regarding our laboratory services or to schedule a consultation, please contact our affiliated dental laboratory directly:
                            <br>
                            <br><b>Soft Smile Dental Laboratory</b>
                            <br>Phone: 78239 49383 , 044-26372500
                            
                            <br>Our team is dedicated to providing you with exceptional dental care and ensuring your satisfaction with every aspect of your treatment. Trust Soft Smile Dental Centre and our affiliated laboratory for all your dental needs.
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/UpdatedImages/CroppedDentist .jpg" style="filter:grayscale(80%);" alt="Awesome Image">
                                        <!-- <img src="./images/CommonLaboratory/15.png" alt="Awesome Image"> -->
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        ...
                                        <!-- <img src="./images/CommonLaboratory/9.png" alt="Awesome Image"> -->
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
