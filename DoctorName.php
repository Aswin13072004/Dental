        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    <div class="sec-title">
                        <h1>Common Doctor Name </h1>
                        <span class="border"></span>
                    </div>
                    <div class="text-box">
                        <p><h1>Meet Our Experienced Dental Professionals</h1>
                            <br>At Soft Smile Dental Centre, we pride ourselves on having a team of highly skilled and compassionate dental professionals dedicated to providing exceptional care to our patients. Meet the individuals who make up our esteemed team:
                            <br>
                            <br>1.Dr. Emily Parker, DMD
                            <br>Dr. Emily Parker brings years of experience and expertise to our practice. Specializing in cosmetic dentistry, she is committed to helping patients achieve their dream smiles through personalized treatment plans tailored to their unique needs.
                            <br>
                            <br>2.Dr. Michael Nguyen, DDS
                            <br>With a passion for restorative dentistry, Dr. Michael Nguyen is known for his gentle approach and attention to detail. Patients appreciate his calming demeanor and commitment to delivering outstanding results while ensuring their comfort throughout their dental journey.
                            <br>
                            <br>3.Dr. Sarah Patel, BDS
                            <br>Dr. Sarah Patel is dedicated to promoting oral health and wellness among her patients. With a focus on preventive care, she educates individuals on the importance of proper oral hygiene practices and strives to create a positive dental experience for every patient who walks through our doors.
                            <br>
                            <br>4.Dr. David Kim, DMD
                            <br>Dr. David Kim is a trusted family dentist known for his warm bedside manner and comprehensive approach to dental care. Whether it's routine cleanings or complex procedures, he prioritizes patient satisfaction and works tirelessly to exceed expectations.
                            <br>
                            <br>5.Dr. Jessica Chen, DDS
                            <br>Dr. Jessica Chen is passionate about pediatric dentistry and takes pride in making dental visits fun and enjoyable for children. Her gentle demeanor and ability to connect with young patients ensure that they receive the highest quality care in a nurturing environment.
                            <br>
                            <br>At Soft Smile Dental Centre, our team of dedicated doctors is committed to helping you achieve and maintain optimal oral health. Schedule an appointment with us today and experience the difference our compassionate care can make in your smile!
                        </p>
                    </div>
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/UpdatedImages/CroppedDentist .jpg"  alt="Awesome Image">
                                        <!-- <img src="./images/CommonName/13.png" alt="Awesome Image"> -->
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/CommonName/4.png" alt="Awesome Image">
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
