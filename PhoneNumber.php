            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Common Phone Number</li>
                    </ul> 
                </div>    
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box">
                        <p><br> For appointments, inquiries, or emergencies, please feel free to reach out to us at:
                            <br> 
                            Phone: +91 78239 49383<br>
                            Telephone: 044-26372500
                            <br> 
                            <br>Our dedicated team at Soft Smile Dental Centre is here to assist you with any dental concerns or scheduling needs. Whether you're due for a routine check-up or require immediate dental attention, we're just a phone call away. Don't hesitate to contact us – your smile is our priority!
                            <br> 
                            </p>
                    </div>
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/CommonPhone number/17.png" alt="Awesome Image">
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/CommonPhone number/19.png" alt="Awesome Image">
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
