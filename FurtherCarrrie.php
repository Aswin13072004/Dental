                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown current"><a href="FurtherCarrrie.php">Carrier <br class="NavbarBreakPoint">guidance</a>
                                    <ul>
...
<section class="breadcrumb-area" style="background-image: url(./images/Futhercarrier/FurtherCarrierCropped.png);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="left pull-left">
                    <div class="title">
                        <h1>Futher Carriers </h1>
                    </div>
                </div>
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Further Carriers</li>
                    </ul> 
                </div>    
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    <div class="sec-title">
                        <h1>Further Carriers </h1>
                        <span class="border"></span>
                    </div>
                    <div class="text-box">
                        <p><b>Launch Your Career with Soft Smile Dental Centre</b>
                            Establishing your career in dentistry is a journey filled with opportunities for growth and advancement. At Soft Smile Dental Centre, we are committed to nurturing the next generation of dental professionals and providing a supportive environment for career development and advancement.
                            <br>
                            <br> <b>Why Choose Soft Smile Dental Centre for Your Career?</b>
                            <br><b>Comprehensive Training:</b> Join our team and gain access to comprehensive training programs and mentorship opportunities designed to help you build a strong foundation of clinical skills and expertise.
                            <br><b>Advanced Technology:</b> Work with state-of-the-art technology and equipment in a modern dental facility, allowing you to stay at the forefront of dental innovation and deliver the highest quality of care to our patients.
                            <br><b>Collaborative Environment:</b> Join a collaborative and supportive team of dental professionals who are dedicated to working together to achieve common goals and provide exceptional patient care.
                            <br><b>Continuing Education:</b> Take advantage of continuing education opportunities and professional development resources to expand your knowledge, enhance your skills, and stay current with the latest advancements in dentistry.
                            <br>
                            <br><b>Career Paths at Soft Smile Dental Centre:</b>
                            <br><b>Clinical Roles:</b> As a dentist, dental hygienist, or dental assistant, you'll play a crucial role in providing direct patient care and ensuring the health and well-being of our patients.
                            <br><b>Administrative Positions:</b> Join our administrative team and contribute to the smooth operation of our practice by managing appointments, handling patient inquiries, and coordinating administrative tasks.
                            <br><b>Educational Opportunities:</b> Explore opportunities to get involved in dental education and mentorship programs, sharing your knowledge and expertise with aspiring dental professionals and contributing to the future of the dental profession.
                        <br>
                            <b>Your Future with Soft Smile Dental Centre:</b>
                            <br>Whether you're just starting your career in dentistry or looking to take the next step in your professional journey, Soft Smile Dental Centre offers a supportive and rewarding environment where you can thrive and reach your full potential. Join us and become part of a team that is dedicated to making a positive impact in the lives of our patients and the community.
                            <br>
                            <br><b>Join Our Team:</b>
                        <br>
                            Ready to take the next step in your dental career? Explore career opportunities at Soft Smile Dental Centre and start your journey towards a fulfilling and successful career in dentistry. We look forward to welcoming you to our team and helping you achieve your professional goals.</p>
                    </div>
                    <div class="img-box">
                        <div class="row">
                            <!--Start single item-->
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/Futhercarrier/1.png" alt="Awesome Image">
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/Futhercarrier/2.png" alt="Awesome Image">
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="all-service">
                            <li class="active">
                                <a href="FurtherCarrrie.php">Further Carrier</a>
                            </li>
                            <li>
