...
<head>
	<meta charset="UTF-8">
	<title>Dental FAQ’s || Dental Care || Responsive HTML 5 Template</title>
            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li class="active">Dental FAQ’s</li>
                    </ul> 
                </div>    
            </div>
        </div>
            ...
            <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12">
                <div class="content-box">
                    <div class="sec-title-two">
                        <h2>Get Answers Here</h2>
                    </div>
                    <div class="accordion-box">
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>How do I take care of my baby/toddler’s teeth?</h4></div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn active"><h4>What types of dental bridges are available?</h4></div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>What are dental implants used for?</h4></div>
                            <div class="accord-content">
                                <p>A Patient Centered Medical Home is a model of healthcare delivery in which care is tailored to the needs & preferences of patients, the Patient Centered Medical  model encourages.</p>
                            </div>
                        </div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>What kind of dental fillings are available?</h4></div>
                            <div class="accord-content">
                                <p>A Patient Centered Medical Home is a model of healthcare delivery in which care is tailored to the needs & preferences of patients, the Patient Centered Medical  model encourages.</p>
                            </div>
                        </div>
                        ...
                        <!--Start single accordion box-->
                        <div class="accordion accordion-block">
                            <div class="accord-btn"><h4>Do all wisdom teeth need to be removed?</h4></div>
                            <div class="accord-content">
                                <p>A Patient Centered Medical Home is a model of healthcare delivery in which care is tailored to the needs & preferences of patients, the Patient Centered Medical  model encourages.</p>
                            </div>
                        </div>
