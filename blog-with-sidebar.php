...
<head>
	<meta charset="UTF-8">
	<title>Blog Large || Dental Care || Responsive HTML 5 Template</title>
...
<!--Start blog area-->
<section id="blog-area" class="blog-v2-area">
    <div class="container">
        <div class="row">
                    ...
                    <div class="single-blog-post">
                        ...
                        <div class="text-holder">
                            <ul class="meta-info">
                                ...
                                <li><a href="#">Dentalcare</a></li>
                            </ul>
                            <a href="blog-single.php">
                                <h3 class="blog-title">How to Prevent Dental Caries</h3>
                            </a> 
                            <div class="text">
                                <p>Pleasures and praising pain was born we will give you a complete of account of the system, expound actual teachings great how all this mistaken idea of denouncing pleasure and praising pain was born and  will give you a complete account of the system, and expound the actual teachings.</p>
                            </div>
                    ...
                    <div class="single-blog-post">
                        ...
                        <div class="text-holder">
                            <ul class="meta-info">
                                ...
                                <li><a href="#">By Venanda Rose</a></li>
                            ...
                            <div class="text">
                                <p>There anyone who loves or pursues desires to obtain pain of itself, because pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, which of us ever undertakes laborious physical exercise.</p>
                            </div>
                            <div class="post-info clearfix">
                                <div class="left pull-left">
                                    <a class="read-more" href="#">Read More</a>    
                                ...
                                <div class="right pull-right">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i>24</a></li>
                                        <li><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>13</a></li>
                                    </ul>    
                                </div>    
                            </div>
                        </div>
                    ...
                    <div class="single-blog-post">
                        ...
                        <div class="text-holder">
                            ...
                            <div class="post-info clearfix">
                                ...
                                <div class="right pull-right">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i>28</a></li>
                                        <li><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>32</a></li>
                                    </ul>    
                                </div>    
                            </div>
                        </div>
                ...
                <div class="sidebar-wrapper">
                    ...
                    <div class="single-sidebar">
                        ...
                        <ul class="categories clearfix">
                            <li><a href="#">Dental Care<span>(6)</span></a></li>
                            <li><a href="#">Healthy Food<span>(2)</span></a></li>
                            <li><a href="#">Latest Technology<span>(5)</span></a></li>
                        ...
                        <ul class="popular-post">
                            <li>
                                ...
                                <div class="title-holder">
                                    <a href="#"><h5 class="post-title">Myths & Facts about Pro-<br>fessional tooth cleaning</h5></a>
                            ...
                            <li>
                                ...
                                <div class="title-holder">
                                    <a href="#"><h5 class="post-title">Know here, Exact way to<br>brush your teeth</h5></a>
                            ...
                            <li>
                                ...
                                <div class="title-holder">
                                    <a href="#"><h5 class="post-title">Allergies and your Dental<br>Restorations</h5></a>
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="fb-feed">
                            <img src="images/sidebar/fb-follow-us.jpg" alt="">
                        </div>     
                    </div> 
                    <!--End single-sidebar-->  
                </div>    
