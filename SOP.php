...
<section class="breadcrumb-area" style="background-image: url(./images/CommonSOP/CommonSOPCropped.png);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="left pull-left">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box">
                        <p><b>Standard Operating Procedures (SOP) at Soft Smile Dental Centre</b>
                            <br>
                            <br>At Soft Smile Dental Centre, we adhere to strict Standard Operating Procedures (SOP) to ensure the highest standards of quality, safety, and patient care. Our SOPs encompass a wide range of protocols and guidelines designed to streamline practice operations, maintain regulatory compliance, and enhance the patient experience. Some key areas covered by our SOPs include:
                            <br>
                           <br><b>Infection Control and Sterilization</b>
                           <br>- We follow rigorous infection control protocols to prevent the spread of infectious diseases and maintain a safe and hygienic environment for our patients and staff.
                           <br>- Our sterilization procedures adhere to industry standards and guidelines, ensuring that all dental instruments and equipment are properly cleaned, disinfected, and sterilized before each use.
                            <br>
                            <br><b>Patient Care and Treatment</b>
                            <br>- Our SOPs outline the steps involved in providing comprehensive dental care to our patients, from initial examinations and diagnoses to treatment planning and follow-up care.
                            <br>- We prioritize patient comfort and satisfaction, and our SOPs include protocols for effective communication, pain management, and patient education throughout the treatment process.
                            <br>
                            <br><b>Emergency Preparedness</b>
                            <br>- In the event of a dental emergency, our team is trained to respond swiftly and effectively to ensure the safety and well-being of our patients.
                            <br>- Our SOPs include emergency protocols for various scenarios, such as medical emergencies, dental trauma, and adverse reactions to treatment, enabling us to provide prompt and appropriate care when needed.
                            <br>
                            <br><b>Record-Keeping and Documentation</b>
                            <br>- We maintain detailed records of patient information, treatment plans, and clinical notes in compliance with privacy regulations and professional standards.
                            <br>- Our SOPs outline the procedures for accurate and thorough documentation, including data entry, record storage, and patient confidentiality measures.
                            <br>
                            <br><b>Continuous Quality Improvement</b>
                            <br>- We are committed to ongoing quality improvement efforts to enhance the delivery of dental care and optimize practice performance.
                            <br>- Our SOPs include mechanisms for monitoring and evaluating key performance indicators, soliciting feedback from patients and staff, and implementing changes to address areas for improvement.
                            <br>
                            <br>At Soft Smile Dental Centre, our SOPs serve as the foundation for delivering exceptional dental care with integrity, professionalism, and compassion. We continuously review and update our procedures to reflect the latest advancements in dentistry and uphold our commitment to excellence.
                    ...
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/UpdatedImages/CroppedTeeth1.jpg" style="filter:grayscale(100%);" alt="Awesome Image">
                                        <!-- <img src="./images/CommonSOP/1.png" alt="Awesome Image"> -->
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/CommonSOP/8.png" alt="Awesome Image">
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
