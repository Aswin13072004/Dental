...
<section class="breadcrumb-area" style="background-image: url(./images/CommonSystem/CommonSystemCropped.png);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="left pull-left">
                    <div class="title">
                        <h1>Common Systems</h1>
                    </div>
                </div>
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Common Systems</li>
                    </ul> 
                </div>    
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box">
                        <p><b>Advanced Dental Systems at Soft Smile Dental Centre</b>
                            <br>
                            <br>Soft Smile Dental Centre utilizes state-of-the-art dental systems to deliver superior care to our patients. Our advanced systems are designed to enhance diagnostic accuracy, treatment precision, and overall patient experience. Here are some of the key systems we employ:
                           <br>
                           <br><b>Digital Imaging Systems</b>
                           <br>Our digital imaging systems, including intraoral cameras and digital radiography, allow us to capture high-resolution images of your teeth and oral structures with minimal discomfort and radiation exposure. These images provide valuable insights for diagnosis and treatment planning.
                            <br>
                            <br><b>CAD/CAM Technology</b>
                            <br>We utilize Computer-Aided Design/Computer-Aided Manufacturing (CAD/CAM) technology to design and fabricate dental restorations, such as crowns, bridges, and veneers, with remarkable precision and efficiency. CAD/CAM technology enables same-day restorations, eliminating the need for multiple appointments and temporary restorations.
                            <br>
                            <br><b>Dental Laser Systems</b>
                            <br>Our dental laser systems offer minimally invasive solutions for a wide range of dental procedures, including gum disease treatment, cavity preparation, and soft tissue surgery. Laser technology provides precise control and promotes faster healing, resulting in reduced discomfort and improved treatment outcomes.
                            <br>
                            <br><b>Practice Management Software</b>
                            <br>We leverage advanced practice management software to streamline administrative tasks, manage patient records, and optimize practice workflows. Our software systems ensure efficient appointment scheduling, seamless communication, and accurate billing, allowing us to focus more on patient care.
                            <br>
                            <br><b>Sterilization and Infection Control Systems</b>
                            <br>Ensuring a safe and hygienic environment is paramount in our practice. We utilize advanced sterilization and infection control systems to maintain the highest standards of cleanliness and safety. Our protocols adhere to industry guidelines and regulatory standards to protect the health and well-being of our patients and staff.
                            <br>
                            <br>At Soft Smile Dental Centre, we are committed to investing in cutting-edge dental systems to deliver exceptional care and achieve superior treatment outcomes for our patients. Experience the benefits of advanced technology and personalized care at our practice.
                    ...
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/CommonSystem/14.png" alt="Awesome Image">
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/CommonSoftware/3.png" alt="Awesome Image">
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
