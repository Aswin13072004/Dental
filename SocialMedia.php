...
<head>
	<meta charset="UTF-8">
	<title>Social Media Engagements</title>
...
<section class="breadcrumb-area" style="background-image: url(PageImages/SocialMediaEngagement/SocialMediaCropped1.png);">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="left pull-left">
                    <div class="title">
                        <h1>Social Media Engagements</h1>
                    </div>
                </div>
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Social Media Engagements</li>
                    </ul> 
                </div>    
            </div>
        </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box" style="color: black;">
                        <p>➢ Facebook, Instagram, Linked in, you tube, etc., - pages with messages, pics & video 
                            contents.
                            <br>➢ Monthly eight/weekly two videos as awareness ,preventive & procedural –
                            common for all clinics
                            <br>➢ Posters</p>    
                    </div>
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/SocialMediaEngagement/SocialMedia365210Cropped (1).png" alt="Awesome Image">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/SocialMediaEngagement/SocialMedia365210Cropped.png" alt="Awesome Image">
