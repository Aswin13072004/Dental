...
<section class="breadcrumb-area" style="background-image: url(PageImages/AboutUs/img\ 2\ -\ cropped.jpg);">
...
<!--Start about us area-->
<section class="about-page-us-area">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="text-holder martop50">
                    <div class="sec-title">
                    ...
                    <div class="text">
                        ...
                        <div class="button-and-signature">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="single-item hvr-float-shadow">
                    ...
                    <div class="text-holder">
                        ...
                        <p>"Our customer support team is here to serve you with dedication and a smile. Your satisfaction is our priority!"</p>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="single-item hvr-float-shadow">
                    ...
                    <div class="text-holder">
                        <h3>Very Fast Aid</h3>
                        <p>"Urgency is our priority! Experience lightning-fast aid from our dedicated team, ensuring your needs are met with speed and efficiency."</p>
                    </div>
                </div>
            </div>
            <!--End single item-->
