            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Home Visits</li>
                    </ul> 
                </div>    
            </div>
        </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box" style="color: black;">
                        <p>➢ House visits for severly medically compromised patients
                            <br>➢ Aged patients
                            <br>➢ Special children & special people.</p>    
                    </div>
                    <div class="img-box">
                        <div class="row">
                            <!--Start single item-->
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/Home visits/home visits (1) cropped.png" alt="Awesome Image">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/Home visits/home visits cropped.png" alt="Awesome Image">
