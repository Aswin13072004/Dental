            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><a href="services.php">Business <br class="NavbarBreakPoint">entity</a></li>
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                    ...
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/Finance/1.png" alt="Awesome Image">
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/Finance/2.png" alt="Awesome Image">
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
