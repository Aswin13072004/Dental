...
<head>
	<meta charset="UTF-8">
	<title>Services Single || Tooth Jewellery || Dental Care || Responsive HTML 5 Template</title>
            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Tooth Jewellery</li>
                    </ul> 
                </div>    
            </div>
        </div>
                    ...
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="images/services/service-single/v5-1.jpg" alt="Awesome Image">
                                    </div>
                                    <h3>Before</h3>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="images/services/service-single/v5-2.jpg" alt="Awesome Image">
                                    </div>
                                    <h3>Before</h3>
                                </div>
                            </div>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="all-service">
                            <li>
                                <a href="root-canel.php">Root Canel</a>
                            </li>
                            <li>
                                <a href="clips-braces.php">Clips & Braces</a>
                            </li>
                            <li>
                                <a href="dental-implant.php">Dental Implant</a>
                            </li>
                            <li>
                                <a href="teeth-whitening.php">Teeth Whitening</a>
                            </li>
                            <li class="active">
                                <a href="tooth-jewellery.php">Tooth Jewellery</a>
                            </li>
                            <li>
                                <a href="teeth-filling.php">Teeth Filling</a>
                            </li>
                        </ul>            
                    </div> 
                    <!--Ens single sidebar--> 
