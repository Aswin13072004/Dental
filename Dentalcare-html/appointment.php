        ...
        <div class="container">
            ...
            <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12"> <!-- Smaller column width on LG, MD, and SM, full width on XS -->
                <div class="makeanapp logo text-center">
                    <a class="thm-btn btn-sm bg-1" href="appointment.html"><h6>Get an appointment</h6></a> <!-- Content adjusted -->
                </div>   
            </div>
        </div>
    </div>
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="current"><a href="appointment.html">Appointment</a></li>
                            </ul>
                        </div>
                    </nav>
                    <!--End mainmenu-->
