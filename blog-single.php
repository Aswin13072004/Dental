...
<head>
	<meta charset="UTF-8">
	<title>Blog Single || Dental Care || Responsive HTML 5 Template</title>
...
<section id="blog-area" class="blog-v2-area blog-single-area">
    <div class="container">
        <div class="row">
                ...
                <div class="blog-post">
                    ...
                    <div class="single-blog-post">
                        <div class="img-holder">
                            <img src="images/blog/single-post.jpg" alt="Awesome Image">
                        </div>
                        <div class="text-holder">
                            <ul class="meta-info">
                            ...
                            <div class="text">
                                <p class="mar-bottom">The great explorer of the truth, the master-builder of human happiness sed worksone rejects, dislikes, avoids pleasure itself, because it is pleasure, but because those who do all know how to pursue pleasure rationally encounter consequences that are extremely seds painful the master-builder of our human happiness rejects, dislikes, or avoids pleasure itself, because it is pursue pleasure.</p>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="inner-text-holder">
                                            <p>They have got my project time with competition  with highly skilled, well-organized denouncing of pleasures experienced professional.</p>
                                            <h3>Dohn Gaskel</h3>
                            ...
                            <div class="tag-social-share-box post-info clearfix">
