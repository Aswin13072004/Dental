...
<section class="breadcrumb-area" style="background-image: url(PageImages/WebsiteForSEO/WebsiteWebSeoCropped.png);">
            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Website with SEO</li>
                    </ul> 
                </div>    
            </div>
        </div>
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box" style="color: black;">
                        <p>➢ Search engine optimization
                            <br>➢ Includes every information
                            <br>➢ Priority for awareness 
                            <br>➢ Explanation of diseases & treatments & Procedures
                            <br>➢ Payments through various options
                            <br>➢ Separate window or portal for attached clinics
                            <br>➢ Option for blog writing & video posting
                            <br>➢ Common phone number for all attached clinics – Customer care number
                            <br>➢ Display of all clinicians & experts name</p>    
                    </div>
                    <div class="img-box">
                        <div class="row">
                            <!--Start single item-->
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/WebsiteForSEO/WebsiteWithSeoCropped.png" alt="Awesome Image">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/WebsiteForSEO/WebsiteWithSeoCropped (1).png" alt="Awesome Image">
