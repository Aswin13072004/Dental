...
<head>
	<meta charset="UTF-8">
	<title>Services Single || Teeth Filling || Dental Care || Responsive HTML 5 Template</title>
            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Teeth Filling</li>
                    </ul> 
                </div>    
            </div>
        </div>
                    ...
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="images/services/service-single/v6-1.jpg" alt="Awesome Image">
                                    </div>
                                    <h3>Before</h3>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="images/services/service-single/v6-2.jpg" alt="Awesome Image">
                                    </div>
                                    <h3>Before</h3>
                                </div>
                            </div>
