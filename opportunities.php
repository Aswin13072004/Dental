...
<head>
	<meta charset="UTF-8">
	<title>Any one can Contact</title>
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown current"><a href="opportunities.php">Employment <br class="NavbarBreakPoint">opportunities</a>
                                    <ul>
            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Any one can Contact</li>
                    </ul> 
                </div>    
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box">
                        <p><b> Join Our Team at Soft Smile Dental Centre</b>
                            
                            <br>Are you passionate about dentistry and committed to delivering exceptional patient care? Soft Smile Dental Centre is always looking for talented individuals to join our team and contribute to our mission of providing high-quality dental services in a compassionate and supportive environment.
                            <br>
                            <br><b>Why Choose Soft Smile Dental Centre for Your Career?</b>
                            
                            <br><b>Professional Growth:</b> Grow your career in a dynamic and supportive environment that values continuous learning and professional development. We offer opportunities for advancement and mentorship to help you reach your full potential.
                            
                            <br><b>Collaborative Culture:</b> Join a team of dedicated professionals who are committed to working together to achieve common goals and deliver the best possible care to our patients. Our collaborative culture fosters teamwork, innovation, and mutual respect.
                            
                            <br><b>State-of-the-Art Facilities:</b> Work in a modern and fully equipped dental facility with state-of-the-art technology and amenities. Our clinic is designed to provide a comfortable and welcoming environment for both patients and staff.
                            
                            <br><b>Commitment to Excellence:</b> Be part of a practice that is committed to excellence in everything we do. From patient care to clinical outcomes to customer service, we strive to exceed expectations and set the standard for quality dental care.
                            <br>
                            <br><b>Current Employment Opportunities:</b>
                            
                            <br>- Dentists
                            <br>- Dental Hygienists
                            <br>- Dental Assistants
                            <br>- Front Desk Receptionists
                            <br>- Administrative Staff
                            <br>- Dental Technicians
                            <br>
                            <br><b>How to Apply:</b>
                    ...
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/employmentoppurtunities/1.png" alt="Awesome Image">
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="./images/employmentoppurtunities/3.png" alt="Awesome Image">
                                    </div>
                                    <!-- <h3>Before</h3> -->
                                </div>
                            </div>
                ...
                <div class="service-sidebar">
                    ...
                    <div class="single-sidebar">
                        <ul class="all-service">
                            <li class="active">
                                <a href="opportunities.php">Any one can Contact</a>
                            </li>
                            <li>
