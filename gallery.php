...
<head>
	<meta charset="UTF-8">
	<title>Gallery || Dental Care || Responsive HTML 5 Template</title>
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown current"><a href="gallery.php">Gallery</a>
                                    <ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/1-before.jpg" alt="Awesome Image">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/1-after.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/2-before.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/2-after.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/3-before.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/3-after.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/4-before.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/4-after.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/5-before.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/5-after.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/6-before.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="single-project-item">
                    <div class="img-holder">
                        <img src="images/projects/6-after.jpg" alt="Awesome Image">
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <div class="text-holder">
