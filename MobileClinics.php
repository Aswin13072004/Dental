...
<section class="breadcrumb-area" style="background-image: url(PageImages/mobileClinics/mobile\ clinics\ 1920230\ cropped.png);">
            ...
            <div class="col-md-12">
                ...
                <div class="right pull-right">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right" aria-hidden="true"></i></li>
                        <li class="active">Mobile Clinics</li>
                    </ul> 
                </div>    
            </div>
        </div>
            ...
            <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12 pull-right"> 
                ...
                <div class="top-content-box">
                    ...
                    <div class="text-box" style="color: black;">
                        <p>Mobile dental clinics are specialized vehicles equipped with dental care facilities that provide dental services to patients in various locations. These clinics are designed to reach 
                            underserved communities, schools, nursing homes, and other areas where access to dental care is limited. Here are some 
                            key aspects of mobile dental clinics:</p>

<h4>Features of Mobile Dental Clinics:</h4><br>
<p>Dental Equipment: Includes dental chairs, lights, X-ray machines, sterilization units, and other necessary dental tools. <br>
Mobility: Built into buses, vans, or trailers, allowing them to travel to different locations. <br>
Staff: Typically staffed by licensed dentists, dental hygienists, and dental assistants. <br>
Services: Provide a range of dental services, including routine check-ups, cleanings, fillings, extractions, and preventive care. <br>
Technology: Often equipped with advanced technology for diagnostics and treatment, such as digital X-rays and electronic health records (EHRs).</p> <br>
<h4>Benefits of Mobile Dental Clinics:</h4><br>
<p>Access to Care: Reach remote or underserved populations who might not have easy access to a dental office. <br>
Convenience: Bring dental services directly to schools, workplaces, and communities, reducing travel time and associated costs for patients. <br>
Education: Provide oral health education and promote preventive care practices. <br>
Cost-Effective: Often lower cost compared to traditional dental clinics, which can be beneficial for uninsured or low-income patients.</p><br>
                    ...
                    <div class="img-box">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/mobileClinics/mobile clinics 365210 cropped (1).png" alt="Awesome Image">
                                        <!-- <img src="images/services/service-single/v4-1.jpg" alt="Awesome Image"> -->
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                            ...
                            <div class="col-md-6">
                                <div class="single-item">
                                    <div class="img-holder">
                                        <img src="PageImages/mobileClinics/mobile clinics 365210 cropped.png" alt="Awesome Image">
                                        <!-- <img src="images/services/service-single/v4-2.jpg" alt="Awesome Image"> -->
                                    </div>
                                </div>
                            </div>
                            <!--End single item-->
                        ...
                        <div class="contact-us">
                            <ul class="contact-info">
                                ...
                                <li>
                                    ...
                                    <div class="text-older">
                                        <h5>SoftSmile@Dentalcare@gmail.com</h5>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon-holder">
