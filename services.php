                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown current"><a href="services.php">Services</a>
                                    <ul>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="single-service-item text-center wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                        ...
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    ...
                                    <a href="root-canel.php">Read More<i class="fa fa-caret-right" aria-hidden="true"></i></a>    
                                </div>
                            </div>
                        </div>
                        <div class="icon-box">
                    ...
                    <div class="title-holder">
                        <a href="root-canel.php"><h3>Root Canel</h3></a>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-4">
                <div class="single-service-item text-center wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                    <div class="img-holder">
                        ...
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <p>Expound the actual teachings the great explorer of the truth, the master  builder of human happiness with smile.</p>
                                    <a href="clips-braces.php">Read More<i class="fa fa-caret-right" aria-hidden="true"></i></a>    
                                </div>
                            </div>
                        </div>
                        <div class="icon-box">
                    ...
                    <div class="title-holder">
                        <a href="clips-braces.php"><h3>Clips & Braces</h3></a>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-4">
                <div class="single-service-item text-center wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                    <div class="img-holder">
                        ...
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <p>Expound the actual teachings the great explorer of the truth, the master  builder of human happiness with smile.</p>
                                    <a href="dental-implant.php">Read More<i class="fa fa-caret-right" aria-hidden="true"></i></a>    
                                </div>
                            </div>
                        </div>
                        <div class="icon-box">
                    ...
                    <div class="title-holder">
                        <a href="dental-implant.php"><h3>Dental Implant</h3></a>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-4">
                <div class="single-service-item text-center wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                    <div class="img-holder">
                        ...
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <p>Expound the actual teachings the great explorer of the truth, the master  builder of human happiness with smile.</p>
                                    <a href="tooth-jewellery.php">Read More<i class="fa fa-caret-right" aria-hidden="true"></i></a>    
                                </div>
                            </div>
                        </div>
                        <div class="icon-box">
                    ...
                    <div class="title-holder">
                        <a href="tooth-jewellery.php"><h3>Tooth Jewellery</h3></a>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-4">
                <div class="single-service-item text-center wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                    <div class="img-holder">
                        ...
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <p>Expound the actual teachings the great explorer of the truth, the master  builder of human happiness with smile.</p>
                                    <a href="teeth-whitening.php">Read More<i class="fa fa-caret-right" aria-hidden="true"></i></a>    
                                </div>
                            </div>
                        </div>
                        <div class="icon-box">
                    ...
                    <div class="title-holder">
                        <a href="teeth-whitening.php"><h3>Teeth Whitening</h3></a>
                    </div>
                </div>
            </div>
            <!--End single item-->
            ...
            <div class="col-md-4">
                <div class="single-service-item text-center wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1s" data-wow-offset="0">
                    <div class="img-holder">
                        ...
                        <div class="overlay-style-one">
                            <div class="box">
                                <div class="content">
                                    <p>Expound the actual teachings the great explorer of the truth, the master  builder of human happiness with smile.</p>
                                    <a href="teeth-filling.php">Read More<i class="fa fa-caret-right" aria-hidden="true"></i></a>    
                                </div>
                            </div>
                        </div>
                        <div class="icon-box">
                    ...
                    <div class="title-holder">
                        <a href="teeth-filling.php"><h3>Teeth Filling</h3></a>
                    </div>
                </div>
            </div>
            <!--End single item-->
